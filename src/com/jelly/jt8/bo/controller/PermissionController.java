...
public class PermissionController extends BaseController{
    ...
    public @ResponseBody
    ResponseEntity<String> getPermissionList(){
    ...
    public @ResponseBody
    ResponseEntity<String> updatePermission(@PathVariable("id") int id, @RequestBody Permission permission){
    ...
    public @ResponseBody
    ResponseEntity<String> removePermission(@PathVariable("id") int id, @RequestBody Permission permission){
    ...
    public @ResponseBody
    ResponseEntity<String> movePermission(@RequestBody PermissionMoveSetting permissionMoveSetting){
